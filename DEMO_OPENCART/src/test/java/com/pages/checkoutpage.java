...
public class checkoutpage {
	...
	By lastname = By.id("input-payment-lastname");
	  ...
	  //country and state drop down
	   ...
	   By newaddresscontinue = By.id("button-payment-address");
	   ...
	   By citydlry = By.id("input-shipping-city");
	  //country and state drop down
	   ...
	   By newaddresscontinuedlry = By.id("button-shipping-address");
	   By dlrycontinue = By.id("button-shipping-method");
	   ...
	   By confirmsubmit = By.id("button-confirm");
